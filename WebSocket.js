...
function initAsClient(address, protocols, options) {
  ...
  var localAddress = options.value.localAddress;
  ...
  if (options.isDefinedAndNonNull('pfx')
   ...
   //|| options.isDefinedAndNonNull('localAddress')
   ...
   || options.isDefinedAndNonNull('rejectUnauthorized')) {
    ...
    if (options.isDefinedAndNonNull('localAddress')) requestOptions.localAddress = options.value.localAddress;
